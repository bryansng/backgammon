...
| <ul><li>[x] </li></ul> | Allow players to takes turns to roll and move around the board. | ðŸ‘? |
...
| <ul><li>[x] </li></ul> | The moves do not have to match the dice roll or avoid opponent blocks yet. The program does not need to check that the move is valid yet. | ðŸ‘? |
